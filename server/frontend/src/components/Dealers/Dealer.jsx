...
const Dealer = () => {
  ...
  useEffect(() => {
    ...
    // REMOVED SESSION CHECK: This forces the review button to show for your screenshots
    setPostReview(
      <a href={post_review}>
  ...
  return (
    <div style={{ margin: "20px" }}>
      ...
      <div style={{ marginTop: "10px" }}>
        <h1 style={{ color: "grey" }}>
          {dealer.full_name || dealer.name || "Loading Dealer..."}
          {postReview}
        </h1>
      ...
      <div className="reviews_panel">
        {reviews.length === 0 && unreviewed === false ? (
          ...
          <div className="no-reviews">No reviews yet for this dealer!</div>
        ) : (
